          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative p-8 rounded-2xl backdrop-blur-sm transition-all duration-300 ${
                plan.popular
                  ? "bg-gradient-to-b from-orange-900/40 to-orange-900/40 border-2 border-orange-500 scale-105 shadow-2xl shadow-orange-500/50"
                  : "bg-white/5 border border-white/10 hover:border-orange-500/50"
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <div className="px-4 py-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full text-white text-sm font-semibold">
                    Most Popular
                  </div>
                </div>
              )}
              ...
              <button
                className={`w-full py-4 rounded-lg font-semibold transition-all ${
                  plan.popular
                    ? "bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white shadow-lg shadow-orange-500/50"
