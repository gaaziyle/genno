    ...
    <section id="how-it-works" className="py-32 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-20 left-1/2 w-full h-0.5 bg-gradient-to-r from-orange-400 to-orange-600 opacity-30" />
                )}

                <div className="relative text-center">
                  {/* Step Number */}
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full text-3xl font-bold text-white mb-6 shadow-lg shadow-orange-500/50">
                    {step.number}
                  </div>
          ...
          {/* Demo Code Block */}
          <div className="mt-20 p-8 bg-gradient-to-br from-orange-900/20 to-orange-900/20 border border-orange-500/20 rounded-2xl">
